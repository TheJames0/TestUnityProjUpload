...
var ASM_CONSTS = {
  2498976: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2499037: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2499101: function() {return Module.webglContextAttributes.powerPreference;},  
 2499159: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2499214: function($0) {performance.now = function() { return $0; };},  
 2499262: function($0) {performance.now = function() { return $0; };},  
 2499310: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _CreateVideoBlobURL(buffer, bufferSize) {
      // Create a Blob from the raw data passed from C#
      var videoBlob = new Blob([HEAPU8.subarray(buffer, buffer + bufferSize)], { type: "video/mp4" });
      
      // Create an object URL from the Blob. This URL points to the data in memory.
      var url = URL.createObjectURL(videoBlob);
      
      // Return the URL as a string to Unity
  ...
  function _RevokeVideoBlobURL(url) {
...
var asmLibraryArg = {
  "CreateVideoBlobURL": _CreateVideoBlobURL,
  ...
  "RevokeVideoBlobURL": _RevokeVideoBlobURL,
